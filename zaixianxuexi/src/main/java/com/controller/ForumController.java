...
//                            forumEntity.setForumName(data.get(0));                    //讨论标题 要改的
...
//                            forumEntity.setForumTypes(Integer.valueOf(data.get(0)));   //讨论类型 要改的
//                            forumEntity.setForumStateTypes(Integer.valueOf(data.get(0)));   //讨论状态 要改的
